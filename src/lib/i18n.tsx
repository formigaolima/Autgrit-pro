...
export const defaultTranslations = {
  ...
  service_aviation_title: "Aviation & eVTOL",
  service_aviation_desc: "Tactical air mobility. Electric helicopters (eVTOL), planes, and professional certified pilot dispatch.",
  service_marine_title: "Marine & Captains",
  service_marine_desc: "Waterway ridesharing and marine transport. Hire captains certified to navigate any vessel type.",
...
const builtInTranslations: Record<string, Partial<typeof defaultTranslations>> = {
  it: {
    ...
    service_aviation_title: "Elicotteri & Aerei (eVTOL)",
    service_aviation_desc: "Mobilità aerea tattica. Elicotteri elettrici (eVTOL), aerei privati e servizi di piloti certificati dedicati.",
    service_marine_title: "Barche & Marinai",
    service_marine_desc: "Condivisione barche e mobilità acquatica. Prenota yacht o imbarcazioni con marinai esperti per qualsiasi navigazione.",
  ...
  pt: {
    ...
    service_aviation_title: "Helicópteros & Aviões (eVTOL)",
    service_aviation_desc: "Mobilidade aérea tática. Helicópteros elétricos (eVTOL), jatos privados e serviços de pilotos certificados dedicados.",
    service_marine_title: "Barcos & Marinheiros",
    service_marine_desc: "Compartilhamento marítimo confiável. Reserve iates ou lanchas com capitães qualificados aptos a navegar qualquer embarcação.",
